    ...
    if not spec_path.exists():
        ...
        if code:
            if axis_requires_log(spec, "x_axis") and not has_log_call(code, "x_axis"):
                errors.append("x_axis spec requires log scale but plot.py does not set xscale('log')")
            if axis_requires_log(spec, "y_axis") and not has_log_call(code, "y_axis"):
                errors.append("y_axis spec requires log scale but plot.py does not set yscale('log')")
